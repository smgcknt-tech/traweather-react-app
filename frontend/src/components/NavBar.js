    ...
    return (
        <div className="nav_bar">
            <ul　className="nav_menu">
                ...
                <Link to="#"><li><i className="fas fa-chess-pawn"></i><p>計画</p></li></Link>
                <Link to="#"><li><i className="fas fa-chart-bar"></i><p>結果</p></li></Link>
                <Link to="#"><li><i className="fas fa-book"></i><p>振返</p></li></Link>
